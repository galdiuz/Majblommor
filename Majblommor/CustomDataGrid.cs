...
namespace Majblommor
{
    public class CustomDataGrid : DataGrid
    {
        ...
        public event PasteFinishedEventHandler PasteFinished;

        public delegate void PasteFinishedEventHandler(object myObject, PasteFinishedEventArgs args);
        ...
        protected virtual void OnExecutedPaste(object target, ExecutedRoutedEventArgs args)
        {
            ...
            PasteFinished(this, new PasteFinishedEventArgs());
        }
